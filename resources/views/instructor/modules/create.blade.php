    ...
    <div class="bg-gradient-to-r from-blue-600 to-purple-600 text-white py-16">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center">
                ...
                <h1 class="text-4xl font-bold mb-4">Criar Novo Módulo</h1>
                <p class="text-xl text-blue-100">Adicione um módulo ao curso: {{ $course->title }}</p>
            </div>
        </div>
    </div>
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 -mt-8 pb-16">
        <div class="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
            <div class="bg-gradient-to-r from-green-500 to-emerald-600 px-8 py-6">
                ...
                <p class="text-white mt-1 font-medium">Organize o conteúdo do seu curso</p>
            </div>
            
            <form method="POST" action="{{ route('instructor.modules.store', $course) }}" class="p-8">
                @csrf
                ...
                <div class="grid grid-cols-1 gap-8">
                    ...
                    <div>
                        ...
                        <textarea id="description" 
                                  ...
                                  rows="4"
                                  class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition"
                                  placeholder="Descreva o que será abordado neste módulo...">{{ old('description') }}</textarea>
                        @error('description')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="flex items-center justify-between pt-8 border-t border-gray-200 mt-8">
                    ...
                    <button type="submit" 
                            class="inline-flex items-center px-8 py-3 bg-gradient-to-r from-green-600 to-emerald-600 text-white rounded-xl font-semibold hover:shadow-lg transform hover:scale-105 transition-all duration-300">
                        <i class="fas fa-plus mr-2"></i>Criar Módulo
                    </button>
                </div>
            </form>
        </div>
