...
@section('title', 'Novo Cliente - DevStarter Kit Demo')
...
<div class="max-w-2xl mx-auto">
    ...
    <div class="mb-6">
        <div class="flex items-center">
            ...
            <div>
                ...
                <p class="text-gray-600 mt-1">Preencha os dados para criar um novo cliente</p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-lg p-6">
        <form action="{{ route('demo.clients.store') }}" method="POST">
            @csrf
